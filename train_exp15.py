...
ssd_loss2 = SSDLoss_proj(neg_pos_ratio=3, alpha=1.0)
...
model_checkpoint = ModelCheckpoint(filepath='checkpoints/train_15_double_ssd300_pascal_07+12_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
