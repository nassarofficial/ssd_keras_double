...
class DataGenerator:
    ...
    def generate_inf_gt(self,
        ...
        while True:
            ...
            if 'original_images' in returns:
                batch_original_images = deepcopy(batch_X) # The original, unaltered images
                batch_original_images1 = deepcopy(batch_Z) # The original, unaltered images
            ...
            yield [batch_X,batch_Z,batch_filenames,batch_inverse_transforms,batch_inverse_transforms1,batch_original_images,batch_original_images1,batch_original_labels,batch_original_labels1]
